...
contract syFRAX is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumFRAX", "syFRAX") {
  }
  ...
  function mint_syFRAX(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syFRAX(address burnedFrom, uint256 amount) public {
