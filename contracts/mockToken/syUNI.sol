...
contract syUNI is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumUNI", "syUNI") {
  }
  ...
  function mint_syUNI(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syUNI(address burnedFrom, uint256 amount) public {
