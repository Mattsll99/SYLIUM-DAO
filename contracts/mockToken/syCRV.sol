...
contract syCRV is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumCRV", "syCRV") {
  }
  ...
  function mint_syCRV(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syCRV(address burnedFrom, uint256 amount) public {
