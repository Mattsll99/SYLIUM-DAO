...
contract syUSDT is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumUSDT", "syUSDT") {
  }
  ...
  function mint_syUSDT(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syUSDT(address burnedFrom, uint256 amount) public {
