...
contract syCAKE is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumCAKE", "syCAKE") {
  }
  ...
  function mint_syCAKE(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syCAKE(address burnedFrom, uint256 amount) public {
