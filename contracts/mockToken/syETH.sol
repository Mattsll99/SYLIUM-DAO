...
contract syETH is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumETH", "syETH") {
  }
  ...
  function mint_syETH(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syETH(address burnedFrom, uint256 amount) public {
