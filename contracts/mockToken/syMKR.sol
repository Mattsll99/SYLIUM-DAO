...
contract syMKR is ERC20, ERC20Burnable, Ownable {
  /* ====================== CONSTRUCTOR =============================== */
  constructor() ERC20("SyliumMKR", "syMKR") {
  }
  ...
  function mint_syMKR(address receiver, uint256 amount) public {
    _mint(receiver, amount);
    emit minting(receiver, amount);
  }

  // Function to burn SYLI 
  function burn_syMKR(address burnedFrom, uint256 amount) public {
